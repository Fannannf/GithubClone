package com.example.githubuserclone.data.response

import com.google.gson.annotations.SerializedName

data class GithubUserRepoResponse(

	@field:SerializedName("GithubUserRepoResponse")
	val githubUserRepoResponse: List<GithubUserRepoResponseItem?>? = null
)

data class GithubUserRepoResponseItem(
